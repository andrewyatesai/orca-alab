...
// Why: a paired remote runtime (SSH/relay) is not trusted to return a
// well-formed scan; validate every field before the web client renders/acts on
// it so a hostile host cannot inject arbitrary port rows (#9776).
