...
// Why: these builders emit small Node scripts the spec runs inside a real PTY to
// reproduce the wide/wrapped markdown-table redraw the renderer must restore.
// They live here (instead of inline in the spec) to keep the spec under the
// file-length budget and to keep the fixture payloads in one named place.
