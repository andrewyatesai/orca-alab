 ...
 */
export function branchIsSafeToDeleteViaExecutor(
  executor: Function,
  branch_name: string
): Promise<boolean>
 ...
 */
export function getUpstreamStatusViaExecutor(
  executor: Function,
  remote_name: string,
  branch_name: string,
 ...
 */
export function gitFetchViaExecutor(
  executor: Function,
 ...
 */
export function gitPullRebaseFromBaseViaExecutor(
  executor: Function,
  base_ref: string
): Promise<void>
...
export function gitPushViaExecutor(
  executor: Function,
  remote_name: string | null | undefined,
 ...
 */
export function validateGitPushTargetRules(
  remote_name: string,
  branch_name: string,
  remote_url?: string | null
): string | undefined
...
export interface InitOutput {
  ...
  readonly buildPullRequestFieldsPrompt: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly getLinearIssueWorkspaceName: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly getUpstreamStatusViaExecutor: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly parseGeneratedPullRequestFields: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly planCommitMessageGeneration: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly validateGitPushTargetRules: (
    a: number,
    b: number,
    c: number,
    d: number,
