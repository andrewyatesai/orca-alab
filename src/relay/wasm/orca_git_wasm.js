...
export function getUpstreamStatusViaExecutor(executor, remote_name, branch_name, remote_url) {
  ...
  const ret = wasm.getUpstreamStatusViaExecutor(
    addHeapObject(executor),
    ptr0,
    len0,
    ptr1,
    len1,
...
export function gitFetchViaExecutor(executor, remote_name, branch_name, remote_url) {
  var ptr0 = isLikeNone(remote_name)
    ? 0
    : passStringToWasm0(remote_name, wasm.__wbindgen_export, wasm.__wbindgen_export2)
  var len0 = WASM_VECTOR_LEN
  var ptr1 = isLikeNone(branch_name)
    ? 0
    : passStringToWasm0(branch_name, wasm.__wbindgen_export, wasm.__wbindgen_export2)
 ...
 * @returns {Promise<void>}
 */
export function gitPushViaExecutor(
  executor,
  remote_name,
  branch_name,
  remote_url,
  ...
  var ptr2 = isLikeNone(remote_url)
    ...
    : passStringToWasm0(remote_url, wasm.__wbindgen_export, wasm.__wbindgen_export2)
  var len2 = WASM_VECTOR_LEN
  const ret = wasm.gitPushViaExecutor(
    addHeapObject(executor),
    ptr0,
    len0,
    ptr1,
...
export function planAgentBinary(default_binary, command_override) {
  ...
  try {
    ...
    const len0 = WASM_VECTOR_LEN
    var ptr1 = isLikeNone(command_override)
      ? 0
      : passStringToWasm0(command_override, wasm.__wbindgen_export, wasm.__wbindgen_export2)
    var len1 = WASM_VECTOR_LEN
  ...
  const import0 = {
    ...
    __wbg_new_b5d9e2fb389fef91: function (arg0, arg1) {
      try {
        ...
        var cb0 = (arg0, arg1) => {
          ...
          state0.a = 0
          try {
            return __wasm_bindgen_func_elem_1708(a, state0.b, arg0, arg1)
          } finally {
            state0.a = a
          }
        }
    ...
    __wbindgen_cast_0000000000000001: function (arg0, arg1) {
      ...
      const ret = makeMutClosure(
        arg0,
        arg1,
        wasm.__wasm_bindgen_func_elem_1619,
        __wasm_bindgen_func_elem_1633
      )
      return addHeapObject(ret)
    },
...
function __wasm_bindgen_func_elem_1633(arg0, arg1, arg2) {
  wasm.__wasm_bindgen_func_elem_1633(arg0, arg1, addHeapObject(arg2))
}

function __wasm_bindgen_func_elem_1708(arg0, arg1, arg2, arg3) {
  wasm.__wasm_bindgen_func_elem_1708(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3))
}
