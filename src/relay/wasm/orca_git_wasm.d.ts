...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_1607: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_1696: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1621: (a: number, b: number, c: number) => void;
