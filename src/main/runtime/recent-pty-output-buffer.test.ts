...
describe('RecentPtyOutputBuffer', () => {
  ...
  it('retainedChunks preserves original chunk boundaries within the window (#9422)', () => {
    const buffer = new RecentPtyOutputBuffer()
  ...
  it('retainedChunks keeps the full original head chunk when the window trims mid-chunk (#9422)', () => {
    const buffer = new RecentPtyOutputBuffer()
  ...
  it('retainedChunks flags a pre-sliced oversized head chunk as partial (#9422)', () => {
    const buffer = new RecentPtyOutputBuffer()
  ...
  it('compact collapses to a single chunk and restores read-time defragmentation (#9422)', () => {
    const buffer = new RecentPtyOutputBuffer()
    let reference: string | undefined
    for (let i = 0; i < 200; i++) {
  ...
  it('retainedChunks window-trimmed join always equals read() (#9422)', () => {
