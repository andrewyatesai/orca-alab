...
static BUILTINS: &[Builtin] = &[
    ...
    Builtin {
        ...
        ansi: [
            ...
            c(0x59, 0x63, 0x77), c(0xbf, 0x61, 0x6a), c(0xa3, 0xbe, 0x8c), c(0xeb, 0xcb, 0x8b),
    ...
    Builtin {
        ...
        ansi: [
            ...
            c(0x7a, 0x82, 0xa8), c(0xff, 0x89, 0x9d), c(0x9f, 0xe0, 0x44), c(0xfa, 0xba, 0x4a),
            c(0x8d, 0xb0, 0xff), c(0xc7, 0xa9, 0xff), c(0xa4, 0xda, 0xff), c(0xc0, 0xca, 0xf5),
        ],
    },
    Builtin {
        ...
        ansi: [
            ...
            c(0x58, 0x5b, 0x70), c(0xf7, 0xae, 0xc2), c(0xc2, 0xec, 0xbf), c(0xfc, 0xd6, 0x82),
            c(0xae, 0xcc, 0xfc), c(0xf3, 0x98, 0xda), c(0xb1, 0xea, 0xe1), c(0xa6, 0xad, 0xc8),
        ],
    },
    Builtin {
        name: "Gruvbox Dark",
    ...
    Builtin {
        ...
        ansi: [
            ...
            c(0x33, 0x5e, 0x69), c(0xcb, 0x4b, 0x16), c(0x58, 0x6e, 0x75), c(0x65, 0x7b, 0x83),
    ...
    Builtin {
        ...
        ansi: [
            c(0x21, 0x25, 0x2b), c(0xe0, 0x6c, 0x75), c(0x98, 0xc3, 0x79), c(0xe5, 0xc0, 0x7b),
            c(0x61, 0xaf, 0xef), c(0xc6, 0x78, 0xdd), c(0x56, 0xb6, 0xc2), c(0xab, 0xb2, 0xbf),
            c(0x76, 0x76, 0x76), c(0xe0, 0x6c, 0x75), c(0x98, 0xc3, 0x79), c(0xe5, 0xc0, 0x7b),
            c(0x61, 0xaf, 0xef), c(0xc6, 0x78, 0xdd), c(0x56, 0xb6, 0xc2), c(0xab, 0xb2, 0xbf),
        ],
    },
];
...
mod tests {
    ...
    fn builtins_well_formed() {
        for b in BUILTINS {
            ...
            assert!(!b.name.eq_ignore_ascii_case("default"), "{} shadows Default", b.name);
            let s = b.to_scheme();
    ...
    fn builtin_palette_values_are_canonical() {
        ...
        assert_eq!(g("Catppuccin Mocha").selection, Some(Rgb::new(0x58, 0x5b, 0x70)));
