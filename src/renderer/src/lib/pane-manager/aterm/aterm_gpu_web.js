...
export class AtermGpuTerminal {
    ...
    advance_effects(dt_ms) {
        wasm.atermgputerminal_advance_effects(this.__wbg_ptr, dt_ms);
    }
    /**
    ...
    effects_next_deadline_ms() {
        const ret = wasm.atermgputerminal_effects_next_deadline_ms(this.__wbg_ptr);
     ...
     */
    is_effects_active() {
        const ret = wasm.atermgputerminal_is_effects_active(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    get scroll_frac_px() {
        const ret = wasm.atermgputerminal_scroll_frac_px(this.__wbg_ptr);
        return ret;
    }
    /**
    ...
    get scroll_frac_rows() {
        const ret = wasm.atermgputerminal_scroll_frac_rows(this.__wbg_ptr);
        return ret;
    }
    /**
    ...
    scroll_lines_frac(delta_rows) {
        wasm.atermgputerminal_scroll_lines_frac(this.__wbg_ptr, delta_rows);
    }
    /**
     ...
     */
    scroll_px(delta_px) {
        wasm.atermgputerminal_scroll_px(this.__wbg_ptr, delta_px);
    }
    /**
     ...
     */
    set_chrome(pad, head) {
        wasm.atermgputerminal_set_chrome(this.__wbg_ptr, pad, head);
    }
    /**
    ...
    set_cursor_glow(enabled, style, color, accent, duration_ms, length, intensity, radius, ring) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.atermgputerminal_set_cursor_glow(this.__wbg_ptr, enabled, ptr0, len0, isLikeNone(color) ? 0x100000001 : (color) >>> 0, isLikeNone(accent) ? 0x100000001 : (accent) >>> 0, duration_ms, length, intensity, radius, ring);
    }
    /**
    ...
    set_cursor_trail(enabled, duration_ms, length, color) {
        wasm.atermgputerminal_set_cursor_trail(this.__wbg_ptr, enabled, duration_ms, length, isLikeNone(color) ? 0x100000001 : (color) >>> 0);
    }
    /**
    ...
    set_cursor_trail_pack(toml) {
        ...
        const ret = wasm.atermgputerminal_set_cursor_trail_pack(this.__wbg_ptr, ptr0, len0);
        let v2;
        if (ret[0] !== 0) {
    ...
    set_sparkle_alt_screen_suppression(on) {
        wasm.atermgputerminal_set_sparkle_alt_screen_suppression(this.__wbg_ptr, on);
    }
    /**
    ...
    set_sparkle_ink(enabled, strength, sweep_ms, loop_) {
        wasm.atermgputerminal_set_sparkle_ink(this.__wbg_ptr, enabled, strength, sweep_ms, loop_);
    }
    /**
    ...
    set_sparkle_languages(languages_csv) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.atermgputerminal_set_sparkle_languages(this.__wbg_ptr, ptr0, len0);
    }
    /**
    ...
    set_sparkle_reduced_motion(on) {
        wasm.atermgputerminal_set_sparkle_reduced_motion(this.__wbg_ptr, on);
    }
    /**
    ...
    set_symbol_font(bytes) {
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.atermgputerminal_set_symbol_font(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
