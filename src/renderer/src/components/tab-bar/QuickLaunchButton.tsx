...
function QuickLaunchAgentMenuItemsInner({
  ...
  // Why (#9790): resolving only the SSH connectionId here made paired-runtime
  // worktrees fall back to LOCAL detection, listing the client's agents instead
  // of the remote server's. Use the same ssh/runtime/local owner resolution as
  // the rest of the tab bar; undefined until the owning repo hydrates.
