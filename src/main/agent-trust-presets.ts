...
// Why (#9621): Codex reads project trust from the MAIN worktree root. A linked
// git worktree has a `gitdir:` .git pointer, so trusting the linked-worktree
// path leaves Codex untrusted and its blocking trust menu fires at launch.
