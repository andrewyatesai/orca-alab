...
// The browser E2EE crypto runs through wasm on this fork (eager-inited at
// renderer bootstrap in production); init it synchronously so the mocked
// handshake's encryptBytes is ready — same setup as web-runtime-client.test.ts.
beforeAll(() => {
