...
export const resolveGitRemoteRebaseSourceViaExecutor: (a: number, b: number, c: number) => number;
...
export const __wasm_bindgen_func_elem_1606: (a: number, b: number) => void;
export const __wasm_bindgen_func_elem_1695: (a: number, b: number, c: number, d: number) => void;
export const __wasm_bindgen_func_elem_1620: (a: number, b: number, c: number) => void;
