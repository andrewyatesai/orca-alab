...
//! Maps the `module` field in each vectors file to the Rust port's dispatch,
//! returning a `serde_json::Value` shaped to match `JSON.stringify` of the TS
//! return. Regenerate after adding/removing a module under `src/modules/`.
