...
function writeBackgroundTerminalChunk(
  ...
  // Why guarded: these callbacks run inside the engine's write-completion loop, where an escaping throw permanently wedges the terminal (see xterm-write-callback-guard.ts).
