...
class AtermTerminal {
     ...
     * @param {number} px
     */
    constructor(rows, cols, font_bytes, px) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArray8ToWasm0(font_bytes, wasm.__wbindgen_export_2);
            const len0 = WASM_VECTOR_LEN;
            wasm.atermterminal_new(retptr, rows, cols, ptr0, len0, px);
    ...
    rgba() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.atermterminal_rgba(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
...
module.exports.AtermTerminal = AtermTerminal;
...
const path = require('path').join(__dirname, 'aterm_wasm_bg.wasm');
