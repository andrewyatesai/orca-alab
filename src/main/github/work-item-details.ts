...
async function getWorkItemParticipants(
  ...
  // Why: fork work items live upstream, so resolve owner/repo with the same upstream-first resolvers as body/comments (#7331); PRs stay on origin (github.com + GHES).
  const ownerRepo =
    item.type === 'issue'
