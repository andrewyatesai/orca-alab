...
export type AtermSearchApi = {
   ...
   *  pushes count/active-index a frame after an issued find / posted next/prev;
   *  in-process the controller notifies on every highlight update
   *  (find/next/prev/refresh/clear). Returns a disposer. */
